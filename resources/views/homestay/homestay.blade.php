        ...
        <div class="container-fluid">
            ...
            <section id="welcome" class="tm-content-box tm-banner margin-b-10">
                <div class="tm-banner-inner">
                    <h1 class="tm-banner-title">Homestay</h1>                        
                </div>                    
            </section>
            ...
            <div class="tm-body">
                ...
                <div class="tm-main-content">
                    ...
                    <div class="tm-content-box tm-content-box-home">                        
                        <img src="{{ asset('assets/img/objek/homestay.jpg') }}" alt="Image 1" class="img-fluid tm-welcome-img">                       
                    ...
                    <div id="#" class="tm-content-box tm-gray-bg tm-services">
                      ...
                      <div id="about" class="tm-content-box">
                        <div class="tm-box-pad tm-bordered-box">
                            <h2 class="tm-section-title">Homestay</h2>
                            <p>Menyediakan 6 kamar, 2 kamar mandi di dalam, 4 kamar mandi di luar. Masing – masing kamar, dua tempat tidur, ac, wifi, ruang tv, dapur masak, ruang makan, ruang keluarga, mushola. Biaya permalam, untuk kamar mandi di dalam 750 ribu, kamar mandi di luar 600 ribu. Ada gazebo di puncak batu. Servis yang disediakan homestay yaitu sarapan pagi, menyewakan alat snorkling, diving, kendaraan sewa, jual paket tour objek wisata natuna di luar maupun di dalam tentunya dengan guide handal. </p>
                          ...
                          <div id="gallery" class="tm-content-box">                        
                            <div class="grid tm-gallery">
                                <figure class="effect-bubba">
                                    <img src="{{ asset('assets/img/homestay/1.jpg') }}" alt="Image 8" class="img-fluid">
                                    <figcaption>
                                        <a href="{{ asset('assets/img/homestay/1full.jpg') }}">View more</a>
                                    </figcaption>
                                </figure>
    
                                <figure class="effect-bubba">
                                    <img src="{{ asset('assets/img/homestay/2.jpg') }}" alt="Image 7" class="img-fluid">
                                    <figcaption>
                                        <a href="{{ asset('assets/img/homestay/2full.jpg') }}">View more</a>
                                    </figcaption>
                                </figure>
    
                                <figure class="effect-bubba">
                                    <img src="{{ asset('assets/img/homestay/3.jpg') }}" alt="Image 5" class="img-fluid">
                                    <figcaption>
                                        <a href="{{ asset('assets/img/homestay/3full.jpg') }}">View more</a>
                                    </figcaption>
                                </figure>
    
                                <figure class="effect-bubba">
                                    <img src="{{ asset('assets/img/homestay/4.jpg') }}" alt="Image 3" class="img-fluid">
                                    <figcaption>
                                        <a href="{{ asset('assets/img/homestay/4full.jpg') }}">View more</a>
                                    </figcaption>
                                </figure>
    
                                <figure class="effect-bubba">
                                    <img src="{{ asset('assets/img/homestay/5.jpg') }}" alt="Image 2" class="img-fluid">
                                    <figcaption>
                                        <a href="{{ asset('assets/img/homestay/5full.jpg') }}">View more</a>
                                    </figcaption>
                                </figure>
    
                                <figure class="effect-bubba">
                                    <img src="{{ asset('assets/img/homestay/6.jpg') }}" alt="Image 4" class="img-fluid">
                                    <figcaption>
                                        <a href="{{ asset('assets/img/homestay/6full.jpg') }}">View more</a>
                                    </figcaption>
                                </figure>   

                                <figure class="effect-bubba">
                                    <img src="{{ asset('assets/img/homestay/7.jpg') }}" alt="Image 6" class="img-fluid">
                                    <figcaption>
                                        <a href="{{ asset('assets/img/homestay/7full.jpg') }}">View more</a>
                                    </figcaption>
                                </figure>                                
                            </div>
                        </div>

        ...
        <div class="container-fluid">
            ...
            <section id="welcome" class="tm-content-box tm-banner margin-b-10">
                <div class="tm-banner-inner">
                    <h1 class="tm-banner-title">Pondok Hijau</h1>                        
                </div>                    
            </section>
            ...
            <div class="tm-body">
                ...
                <div class="tm-main-content">
                    ...
                    <div class="tm-content-box tm-content-box-home">                        
                        <img src="{{ asset('assets/img/objek/rumah.jpg') }}" alt="Image 1" class="img-fluid tm-welcome-img">                       
                    ...
                    <div id="#" class="tm-content-box tm-gray-bg tm-services">
                      ...
                      <div id="about" class="tm-content-box">
                        <div class="tm-box-pad tm-bordered-box">
                            <h2 class="tm-section-title">Pondok Hijau</h2>
                            <p>Niat wal dibuatnya pondok hijau kedepannya  untuk tempat berjualan makanan, minuman, dan souvenir Alif Stone Park bagi para pengunjung. Rumah Hijau Juga bisa di jadikan Tempat penyewaan alat snorkling, diving, dan bodyboard. Tapi sementara ini, rumah hijau di isi dengan botol – botol bekas yang hanyut di pantai agar pantai tidak kotor. Kedepannya mungkin botol – botol yang di kumpulkan akan berguna untuk di buatnya inovasi seperti taman botol.</p>
                          ...
                          <div id="gallery" class="tm-content-box">                        
                            <div class="grid tm-gallery">
                                <figure class="effect-bubba">
                                    <img src="{{ asset('assets/img/rumah/1.jpg') }}" alt="Image 8" class="img-fluid">
                                    <figcaption>
                                        <a href="{{ asset('assets/img/rumah/1full.jpg') }}">View more</a>
                                    </figcaption>
                                </figure>
    
                                <figure class="effect-bubba">
                                    <img src="{{ asset('assets/img/rumah/2.jpg') }}" alt="Image 7" class="img-fluid">
                                    <figcaption>
                                        <a href="{{ asset('assets/img/rumah/2full.jpg') }}">View more</a>
                                    </figcaption>
                                </figure>
    
                                <figure class="effect-bubba">
                                    <img src="{{ asset('assets/img/rumah/3.jpg') }}" alt="Image 5" class="img-fluid">
                                    <figcaption>
                                        <a href="{{ asset('assets/img/rumah/3full.jpg') }}">View more</a>
                                    </figcaption>
                                </figure>
    
                                <figure class="effect-bubba">
                                    <img src="{{ asset('assets/img/rumah/4.jpg') }}" alt="Image 3" class="img-fluid">
                                    <figcaption>
                                        <a href="{{ asset('assets/img/rumah/4full.jpg') }}">View more</a>
                                    </figcaption>
                                </figure>
    
                                <figure class="effect-bubba">
                                    <img src="{{ asset('assets/img/rumah/5.jpg') }}" alt="Image 2" class="img-fluid">
                                    <figcaption>
                                        <a href="{{ asset('assets/img/rumah/5full.jpg') }}">View more</a>
                                    </figcaption>
                                </figure>
    
                                <figure class="effect-bubba">
                                    <img src="{{ asset('assets/img/rumah/6.jpg') }}" alt="Image 4" class="img-fluid">
                                    <figcaption>
                                        <a href="{{ asset('assets/img/rumah/6full.jpg') }}">View more</a>
                                    </figcaption>
                                </figure> 
                                <figure class="effect-bubba">
                                    <img src="{{ asset('assets/img/rumah/7.jpg') }}" alt="Image 7" class="img-fluid">
                                    <figcaption>
                                        <a href="{{ asset('assets/img/rumah/7full.jpg') }}">View more</a>
                                    </figcaption>
                                </figure>   
                                <figure class="effect-bubba">
                                    <img src="{{ asset('assets/img/rumah/8.jpg') }}" alt="Image 8" class="img-fluid">
                                    <figcaption>
                                        <a href="{{ asset('assets/img/rumah/8full.jpg') }}">View more</a>
                                    </figcaption>
                                </figure>   
                                <figure class="effect-bubba">
                                    <img src="{{ asset('assets/img/rumah/9.jpg') }}" alt="Image 9" class="img-fluid">
                                    <figcaption>
                                        <a href="{{ asset('assets/img/rumah/9full.jpg') }}">View more</a>
                                    </figcaption>
                                </figure>                                  
                            </div>
                        </div>

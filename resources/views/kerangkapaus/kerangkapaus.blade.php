        ...
        <div class="container-fluid">
            ...
            <section id="welcome" class="tm-content-box tm-banner margin-b-10">
                <div class="tm-banner-inner">
                    <h1 class="tm-banner-title">Kerangka Paus</h1>                        
                </div>                    
            </section>
            ...
            <div class="tm-body">
                ...
                <div class="tm-main-content">
                    ...
                    <div class="tm-content-box tm-content-box-home">                        
                        <img src="{{ asset('assets/img/objek/tengkorak.jpg') }}" alt="Image 1" class="img-fluid tm-welcome-img">                       
                    ...
                    <div id="#" class="tm-content-box tm-gray-bg tm-services">
                      ...
                      <div id="about" class="tm-content-box">
                        <div class="tm-box-pad tm-bordered-box">
                            <h2 class="tm-section-title">Kerangka Paus</h2>
                          ...
                          <div id="gallery" class="tm-content-box">                        
                            <div class="grid tm-gallery">
                                <figure class="effect-bubba">
                                    <img src="{{ asset('assets/img/kerangka/1.jpg') }}" alt="Image 8" class="img-fluid">
                                    <figcaption>
                                        <a href="{{ asset('assets/img/kerangka/1full.jpg') }}">View more</a>
                                    </figcaption>
                                </figure>
    
                                <figure class="effect-bubba">
                                    <img src="{{ asset('assets/img/kerangka/2.jpg') }}" alt="Image 7" class="img-fluid">
                                    <figcaption>
                                        <a href="{{ asset('assets/img/kerangka/2full.jpg') }}">View more</a>
                                    </figcaption>
                                </figure>
    
                                <figure class="effect-bubba">
                                    <img src="{{ asset('assets/img/kerangka/3.jpg') }}" alt="Image 5" class="img-fluid">
                                    <figcaption>
                                        <a href="{{ asset('assets/img/kerangka/3full.jpg') }}">View more</a>
                                    </figcaption>
                                </figure>
    
                                <figure class="effect-bubba">
                                    <img src="{{ asset('assets/img/kerangka/4.jpg') }}" alt="Image 3" class="img-fluid">
                                    <figcaption>
                                        <a href="{{ asset('assets/img/kerangka/4full.jpg') }}">View more</a>
                                    </figcaption>
                                </figure>
    
                                <figure class="effect-bubba">
                                    <img src="{{ asset('assets/img/kerangka/5.jpg') }}" alt="Image 2" class="img-fluid">
                                    <figcaption>
                                        <a href="{{ asset('assets/img/kerangka/5full.jpg') }}">View more</a>
                                    </figcaption>
                                </figure>
    
                                <figure class="effect-bubba">
                                    <img src="{{ asset('assets/img/kerangka/6.jpg') }}" alt="Image 4" class="img-fluid">
                                    <figcaption>
                                        <a href="{{ asset('assets/img/kerangka/6full.jpg') }}">View more</a>
                                    </figcaption>
                                </figure>                                
                            </div>
                        </div>

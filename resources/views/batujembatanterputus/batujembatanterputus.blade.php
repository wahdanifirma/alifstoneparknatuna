...
<head>
    ...
    <title>Batu Jembatan Terputus</title>
<!--
Pipeline
        ...
        <div class="container-fluid">
            ...
            <section id="welcome" class="tm-content-box tm-banner margin-b-10">
                <div class="tm-banner-inner">
                    <h1 class="tm-banner-title">Batu Jembatan Terputus</h1>                        
                </div>                    
            </section>
            ...
            <div class="tm-body">
                ...
                <div class="tm-main-content">
                    ...
                    <div class="tm-content-box tm-content-box-home">                        
                        <img src="{{ asset('assets/img/objek/goa.jpg') }}" alt="Image 1" class="img-fluid tm-welcome-img">                       
                    ...
                    <div id="#" class="tm-content-box tm-gray-bg tm-services">
                      ...
                      <div id="about" class="tm-content-box">
                        <div class="tm-box-pad tm-bordered-box">
                            <h2 class="tm-section-title">Batu Jembatan Terputus</h2>
                            <p>Goa ini terbentuk alami dengan 4 batu besar yang saling menempel satu sama lain dekat dengan bibir pantai Alif Stone Park. Untuk ke Objek Wisata ini kita harus turun dari jalan bukit Alif Stone Park yang di sekitar bukit ada objek wisata Asking Stone. Jarak yang di tempuh untuk sampai ke Goa yaitu sekitar 1,64 menit turun dari bukit. Goa biasanya di fungsi untuk berdiskusi, camping, dan lain – lain.</p>
                          ...
                          <div id="gallery" class="tm-content-box">                        
                            <div class="grid tm-gallery">
                                <figure class="effect-bubba">
                                    <img src="{{ asset('assets/img/bjt/1.jpg') }}" alt="Image 8" class="img-fluid">
                                    <figcaption>
                                        <a href="{{ asset('assets/img/bjt/1full.jpg') }}">View more</a>
                                    </figcaption>
                                </figure>
    
                                <figure class="effect-bubba">
                                    <img src="{{ asset('assets/img/bjt/2.jpg') }}" alt="Image 7" class="img-fluid">
                                    <figcaption>
                                        <a href="{{ asset('assets/img/bjt/2full.jpg') }}">View more</a>
                                    </figcaption>
                                </figure>
    
                                <figure class="effect-bubba">
                                    <img src="{{ asset('assets/img/bjt/3.jpg') }}" alt="Image 5" class="img-fluid">
                                    <figcaption>
                                        <a href="{{ asset('assets/img/bjt/3full.jpg') }}">View more</a>
                                    </figcaption>
                                </figure>
    
                                <figure class="effect-bubba">
                                    <img src="{{ asset('assets/img/bjt/4.jpg') }}" alt="Image 3" class="img-fluid">
                                    <figcaption>
                                        <a href="{{ asset('assets/img/bjt/4full.jpg') }}">View more</a>
                                    </figcaption>
                                </figure>
    
                                <figure class="effect-bubba">
                                    <img src="{{ asset('assets/img/bjt/5.jpg') }}" alt="Image 2" class="img-fluid">
                                    <figcaption>
                                        <a href="{{ asset('assets/img/bjt/5full.jpg') }}">View more</a>
                                    </figcaption>
                                </figure>
    
                                <figure class="effect-bubba">
                                    <img src="{{ asset('assets/img/bjt/6.jpg') }}" alt="Image 4" class="img-fluid">
                                    <figcaption>
                                        <a href="{{ asset('assets/img/bjt/6full.jpg') }}">View more</a>
                                    </figcaption>
                                </figure>
                                <figure class="effect-bubba">
                                    <img src="{{ asset('assets/img/bjt/7.jpg') }}" alt="Image 1" class="img-fluid">
                                    <figcaption>
                                        <a href="{{ asset('assets/img/bjt/7full.jpg') }}">View more</a>
                                    </figcaption>
                                </figure>
                                <figure class="effect-bubba">
                                    <img src="{{ asset('assets/img/bjt/8.jpg') }}" alt="Image 6" class="img-fluid">
                                    <figcaption>
                                        <a href="{{ asset('assets/img/bjt/8full.jpg') }}">View more</a>
                                    </figcaption>
                                </figure>
                                <figure class="effect-bubba">
                                    <img src="{{ asset('assets/img/bjt/9.jpg') }}" alt="Image 9" class="img-fluid">
                                    <figcaption>
                                        <a href="{{ asset('assets/img/bjt/9full.jpg') }}">View more</a>
                                    </figcaption>
                                </figure>                                          
                            </div>
                        </div>

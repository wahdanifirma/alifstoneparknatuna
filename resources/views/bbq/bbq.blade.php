        ...
        <div class="container-fluid">
            ...
            <section id="welcome" class="tm-content-box tm-banner margin-b-10">
                <div class="tm-banner-inner">
                    <h1 class="tm-banner-title">Tempat BBQ</h1>                        
                </div>                    
            </section>
            ...
            <div class="tm-body">
                ...
                <div class="tm-main-content">
                    ...
                    <div class="tm-content-box tm-content-box-home">                        
                        <img src="{{ asset('assets/img/objek/bbq.jpg') }}" alt="Image 1" class="img-fluid tm-welcome-img">                       
                    ...
                    <div id="#" class="tm-content-box tm-gray-bg tm-services">
                      ...
                      <div id="about" class="tm-content-box">
                        <div class="tm-box-pad tm-bordered-box">
                            <h2 class="tm-section-title">Tempat BBQ</h2>
                            <p>Fasilitas ini di fungsikan untuk tempat pengunjung melakukan Kegiatan BBQ , untuk tempat bersantai, tempat Spot Foto seperti Preweding dan lainnya. </p>
                    ...
                    <div id="#" class="tm-content-box tm-light-bg tm-services">
                          ...
                          <div id="gallery" class="tm-content-box">                        
                            <div class="grid tm-gallery">
                                <figure class="effect-bubba">
                                    <img src="{{ asset('assets/img/bbq/1.jpg') }}" alt="Image 8" class="img-fluid">
                                    <figcaption>
                                        <a href="{{ asset('assets/img/bbq/1full.jpg') }}">View more</a>
                                    </figcaption>
                                </figure>
    
                                <figure class="effect-bubba">
                                    <img src="{{ asset('assets/img/bbq/2.jpg') }}" alt="Image 7" class="img-fluid">
                                    <figcaption>
                                        <a href="{{ asset('assets/img/bbq/2full.jpg') }}">View more</a>
                                    </figcaption>
                                </figure>
    
                                <figure class="effect-bubba">
                                    <img src="{{ asset('assets/img/bbq/3.jpg') }}" alt="Image 5" class="img-fluid">
                                    <figcaption>
                                        <a href="{{ asset('assets/img/bbq/3full.jpg') }}">View more</a>
                                    </figcaption>
                                </figure>
    
                                <figure class="effect-bubba">
                                    <img src="{{ asset('assets/img/bbq/4.jpg') }}" alt="Image 3" class="img-fluid">
                                    <figcaption>
                                        <a href="{{ asset('assets/img/bbq/4full.jpg') }}">View more</a>
                                    </figcaption>
                                </figure>
    
                                <figure class="effect-bubba">
                                    <img src="{{ asset('assets/img/bbq/5.jpg') }}" alt="Image 2" class="img-fluid">
                                    <figcaption>
                                        <a href="{{ asset('assets/img/bbq/5full.jpg') }}">View more</a>
                                    </figcaption>
                                </figure>
    
                                <figure class="effect-bubba">
                                    <img src="{{ asset('assets/img/bbq/6.jpg') }}" alt="Image 4" class="img-fluid">
                                    <figcaption>
                                        <a href="{{ asset('assets/img/bbq/6full.jpg') }}">View more</a>
                                    </figcaption>
                                </figure>                                
                            </div>
                        </div>
